...
public interface ClinicalAlertRepository extends JpaRepository<ClinicalAlert, UUID> {
        ...
        /** Monitoring-insights timeline — system-raised events for a visit within a window. */
        List<ClinicalAlert> findByVisitIdAndIsActiveTrueAndAutoGeneratedTrueAndCreatedAtAfterOrderByCreatedAtAsc(
