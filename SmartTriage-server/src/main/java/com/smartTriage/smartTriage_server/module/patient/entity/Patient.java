...
@Table(name = "patients", indexes = {
        ...
        // idx_patient_unidentified is a partial index — defined in V28
        // migration directly because JPA @Index does not support WHERE.
})
@Getter
@Setter
@NoArgsConstructor
...
public class Patient extends BaseEntity {
    ...
    // ═══════════════════════════════════════════════════════════════
    // Unidentified-patient identity placeholder (V28 — Direct Resus)
    //
