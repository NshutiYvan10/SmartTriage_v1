  ...
  const allSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'vitals-rounds', label: 'Vitals Rounds', icon: AlarmClock, pageId: 'monitoring' as AppPage },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'med-safety/overrides', label: 'Med-Safety Reviews', icon: Pill, pageId: 'med-safety-overrides' as AppPage },
