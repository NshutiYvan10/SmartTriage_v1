...
import {
  ...
  MessageSquare, Timer, Siren, Zap, Files, ExternalLink,
} from 'lucide-react';
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Patient identity + location — WHO + WHERE, prominent before the clinical payload. */}
                        <PatientContextLine
                          patientName={report.patientName}
                          zone={report.currentZone}
                          bedLabel={report.currentBedLabel}
                          visitNumber={report.visitNumber}
                          className={`text-[12px] mb-1 ${text.body}`}
                        />
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <button
                          onClick={(e) => { e.stopPropagation(); navigate(chartPath(report.visitId)); }}
                          title="Open patient chart"
                          className="print:hidden inline-flex items-center gap-1.5 px-3 py-2 text-[11px] font-bold text-slate-700 bg-slate-500/10 hover:bg-slate-500/20 rounded-xl transition-all"
                        >
