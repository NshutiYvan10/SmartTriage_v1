...
const PREFIX: Array<[string, string, AuditCategory]> = [
  ...
  ['POST /shift-templates', 'Shift planner change', 'Administration'],
  ['PUT /shift-templates', 'Shift planner change', 'Administration'],
  ['DELETE /shift-templates', 'Shift planner change', 'Administration'],
