  ...
  return (
    <div className="min-h-full">
      <div className="p-4 lg:p-6 max-w-6xl mx-auto space-y-4 animate-fade-in">
        ...
        {/* Monitor management (register / pair / power / recording) moved to its
            own page — /monitor — so the Siren page keeps only run workflow.
            The run-side "Pull from my monitor" stays in EmsRunForm step 2. */}
      </div>
