...
export type AlertType =
  ...
  | 'SYSTEM_OFFLINE' | 'SYSTEM_ONLINE' | 'SAFETY_INCIDENT_CRITICAL' | 'SAFETY_FOLLOWUP_OVERDUE'
  ...
  | 'GLUCOSE_MEASUREMENT_DUE' | 'GLUCOSE_MEASUREMENT_OVERDUE'
  | 'ISOLATION_REQUIRED' | 'ISOLATION_PLACEMENT_OVERDUE' | 'NOTIFIABLE_DISEASE'
  | 'ISOLATION_SCREENING_REQUIRED'
  | 'PATHWAY_ACTIVATED' | 'PATHWAY_STEP_OVERDUE'
  | 'NEW_LAB_ORDER' | 'LAB_ORDER_CANCELLED' | 'NEW_IMAGING_ORDER'
  | 'EMS_ARRIVAL_ACKNOWLEDGED' | 'EMS_HANDOVER_COMPLETE' | 'EMS_FIELD_TRIAGE_CONFIRMED';
